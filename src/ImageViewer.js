        ...
        return (
            <Card style={{ minWidth: 268, width: 268 }}>
                ...
                <span style={{ textAlign: 'center' }}>
                    <Icon
                        onClick={() => {
                            this.setState({ imageIndex: this.props.images && this.state.imageIndex === 0 ? this.props.images.length - 1 : this.state.imageIndex - 1 })
                        }}
                    ...
                    <span style={{ position: 'relative', bottom: 10 }}>
                        {this.state.imageIndex + 1}/{this.props.images && this.props.images.length}
                    </span>
                    <Icon
                        onClick={() => {
                            this.setState({ imageIndex: this.props.images && this.state.imageIndex === this.props.images.length - 1 ? 0 : this.state.imageIndex + 1 })
                        }}
                        style={{ cursor: 'pointer', float: 'right', position: 'relative', right: 10, bottom: 10 }}
                        name="arrow alternate circle right"></Icon>
                </span>
